            ...
            <div class="document">
                <div class="row">
                    <div class="col-6">
                        <strong>To:</strong>
                        <div>
                            <span><strong>Mr/Mrs.</strong> {{model.customer.text}}</span>
                    ...
                    <div class="col-6 col-offset-12">
                        <table class="document-summary">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <span class="document-title">Billing</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Number</td>
                    ...
                    <table class="table document-table">
                        ...
                        <tbody>
                            <tr v-for="item in model.items" :key="item.id">
                                ...
                                <td class="w-3">Rs. {{item.unit_price | formatMoney}}</td>
                                <td class="w-2">{{item.qty}}</td>
                                <td class="w-4">Rs. {{item.qty * item.unit_price | formatMoney}}</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
